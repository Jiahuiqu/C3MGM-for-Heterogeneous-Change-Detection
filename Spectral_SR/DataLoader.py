...
class Datasat(Dataset):
    def __init__(self, mode):
        ...
        if mode == 'train':
            self.PAN_path = '/media/xd132/USER/LS/融合数据集/KAUST_SpectralReflectanceImages_crop_grad/train/MSI/'
            self.img_path1 = os.listdir(self.PAN_path)
            self.img_path1 = sorted(self.img_path1, key=sort_by_number)
            self.HS_path = '/media/xd132/USER/LS/融合数据集/KAUST_SpectralReflectanceImages_crop_grad/train/HSI/'
            self.img_path2 = os.listdir(self.HS_path)
            self.img_path2 = sorted(self.img_path2, key=sort_by_number)
            self.gtHS_path = '/media/xd132/USER/LS/融合数据集/KAUST_SpectralReflectanceImages_crop_grad/train/HSI/'
            self.img_path3 = os.listdir(self.gtHS_path)
            self.img_path3 = sorted(self.img_path3, key=sort_by_number)

        if mode == 'test':
            self.PAN_path = '/media/xd132/USER/LS/融合数据集/KAUST_SpectralReflectanceImages_crop_grad/test/MSI/'
            self.img_path1 = os.listdir(self.PAN_path)
            self.img_path1 = sorted(self.img_path1, key=sort_by_number)
            self.HS_path = '/media/xd132/USER/LS/融合数据集/KAUST_SpectralReflectanceImages_crop_grad/test/HSI/'
            self.img_path2 = os.listdir(self.HS_path)
            self.img_path2 = sorted(self.img_path2, key=sort_by_number)
            self.gtHS_path = '/media/xd132/USER/LS/融合数据集/KAUST_SpectralReflectanceImages_crop_grad/test/HSI/'
            self.img_path3 = os.listdir(self.gtHS_path)
            self.img_path3 = sorted(self.img_path3, key=sort_by_number)
